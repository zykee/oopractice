...
describe("practice_12",()=>{
    ...
    it("Teacher add Leader",()=>{
        var introduce = "I am Tom. I know Jerry become Leader of Class 2.";
        var klass = [];
        klass[0] = new Klass(2);
        klass[1] = new Klass(3);
        var aTeacher = new Teacher('Tom',21,klass);
        var aStudent = new Student('Jerry',13,klass[0])
        var outPut = klass[0].assignLeader(aStudent);
        expect(outPut).toEqual(introduce);
    });
    it("Teacher add Member",()=>{
        var introduce = "I am Tom. I know Jerry has joined Class 2.";
        var klass = [];
        klass[0] = new Klass(2);
        klass[1] = new Klass(3);
        var aTeacher = new Teacher('Tom',21,klass);
        var aStudent = new Student('Jerry',13,klass[1])
        var outPut = klass[0].appendMember(aStudent);
        expect(outPut).toEqual(introduce);
    });
});